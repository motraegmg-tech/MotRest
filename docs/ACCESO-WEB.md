...
4. **Dominio propio (opcional):** Settings → Domains → por ejemplo `app.motrest.mx`.
   Si lo pones, añádelo también en el paso 3.1 y en el 3.3.
...
- **Tablero:** Supabase → **Edge Functions → Secrets** → *Add new secret*
  ...
  - Value: `https://motrest.vercel.app` (varios, separados por coma:
    `https://motrest.vercel.app,https://app.motrest.mx`)
